...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-------|
   * |        | ISRT   |        |        |        |        | VOL-   | MUTE   | VOL+   | LEFT   | DOWN   | UP     | RIGHT  |        |       |
   * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-------|
   * |        |        |        |        |        |        | RWND   | PLAY   | FWRD   |        |        |        |        |        |       |
   * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-------|
   * |        |        |        |        | DEL    |        | PREV   | STOP   | NEXT   |        |        |        |        |        |       |
  ...
  [_FN2] = LAYOUT_ortho_5x15(
      ...
      _______, TO(_ISR),_______, _______, _______, _______, KC_VOLD, KC_MUTE, KC_VOLU, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,_______, _______,
...
combo_t key_combos[COMBO_COUNT] = {
  ...
  [COMBO_3] = COMBO(kc_a_s, KC_LALT),
  [COMBO_4] = COMBO(kc_s_d, KC_LGUI),
  [COMBO_5] = COMBO(kc_d_f, KC_LCTL),
  [COMBO_6] = COMBO(kc_a_s_d, LALT(KC_LGUI)),
  [COMBO_7] = COMBO(kc_s_d_f, LCTL(KC_LGUI)),
  [COMBO_8] = COMBO(kc_a_f, LCTL(KC_LALT)),
  [COMBO_9] = COMBO(kc_w_e, KC_LSFT),
  [COMBO_10] = COMBO(kc_w_e_f, LCTL(KC_LSFT)),
  [COMBO_11] = COMBO(kc_a_w_e, LALT(KC_LSFT)),
  [COMBO_12] = COMBO(kc_scln_l, KC_RALT),
  [COMBO_13] = COMBO(kc_l_k, KC_RGUI),
  [COMBO_14] = COMBO(kc_k_j, KC_RCTL),
  [COMBO_15] = COMBO(kc_scln_l_k, RALT(KC_RGUI)),
  [COMBO_16] = COMBO(kc_l_k_j, RCTL(KC_RGUI)),
  [COMBO_17] = COMBO(kc_scln_j, RCTL(KC_RALT)),
  [COMBO_18] = COMBO(kc_i_o, KC_RSFT),
  [COMBO_19] = COMBO(kc_i_o_j, RCTL(KC_RSFT)),
  [COMBO_20] = COMBO(kc_scln_w_o, RALT(KC_RSFT)),
};
