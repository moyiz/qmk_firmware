...
combo_t key_combos[COMBO_COUNT] = {
    [COMBO_1]  = COMBO(kc_q_w, KC_GESC),
    [COMBO_2]  = COMBO(kc_o_p, KC_BSPC),
    [COMBO_3]  = COMBO(kc_q_p, QK_BOOT),
    [COMBO_4]  = COMBO(tt_sy_nm, OSL(_SS)),
    [COMBO_5]  = COMBO(kc_f_d, OSM(MOD_LCTL)),
    [COMBO_6]  = COMBO(kc_f_s, OSM(MOD_LGUI)),
    [COMBO_7]  = COMBO(kc_f_a, OSM(MOD_LALT)),
    [COMBO_8]  = COMBO(kc_f_d_s, OSM(MOD_LCTL | MOD_LGUI)),
    [COMBO_9]  = COMBO(kc_f_s_a, OSM(MOD_LALT | MOD_LGUI)),
    [COMBO_10] = COMBO(kc_f_d_s_a, OSM(MOD_LCTL | MOD_LALT | MOD_LGUI)),
    [COMBO_11] = COMBO(kc_j_k, OSM(MOD_LCTL)),
    [COMBO_12] = COMBO(kc_j_l, OSM(MOD_LGUI)),
    [COMBO_13] = COMBO(kc_j_scln, OSM(MOD_LALT)),
    [COMBO_14] = COMBO(kc_j_k_l, OSM(MOD_LCTL | MOD_LGUI)),
    [COMBO_15] = COMBO(kc_j_l_scln, OSM(MOD_LALT | MOD_LGUI)),
    [COMBO_16] = COMBO(kc_j_k_l_scln, OSM(MOD_LCTL | MOD_LALT | MOD_LGUI)),
    [COMBO_17] = COMBO(kc_q_w_e_r, SH_TG),
    [COMBO_18] = COMBO(kc_u_i_o_p, SH_TG),
};
